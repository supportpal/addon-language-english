...
return array(
    ...
    "first_response_time_desc"          => "The time taken for the first operator response to tickets.",
    ...
    "time_to_resolution_desc"           => "The time taken for a ticket to be closed after being opened, only includes tickets that are currently closed.",
