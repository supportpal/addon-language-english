...
return array(
     ...
     * 6.0.0
     */
    "mysql_server_version_desc" => "Database server version :min or greater is required to run SupportPal. Found: ':version'.",
    "help_mysql_version"        => "For assistance installing a new version of MySQL or another supported database, please contact your hosting provider or server administrator.",
    "mysql_version"             => "Database Version",
    "mysql_version_not_found"   => "Not available, found database version: :version",
    "mysql_client_version_desc" => "Database client version :min or greater is required to run SupportPal. Found: ':version'.",
