...
return array(
     ...
     * 6.0.0
     */
    "ticket_merged"                     => "Merged :new_value into ticket #:rel.",
    "ticket_added_cc"                   => "Added :new_value to CC address list for ticket #:rel.",
    "ticket_removed_cc"                 => "Removed :old_value from CC address list for ticket #:rel.",
